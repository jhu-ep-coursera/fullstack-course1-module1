...
# These are the suggested installation instructions for Fedora for class. There is 
...
# We will make the necessary detour from the Ubuntu-specific instructions and return at
# the end once we have rbenv installed.
